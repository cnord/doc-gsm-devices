...
* Число контролируемых изделием состояний проводных шлейфов – до четырех («норма», «тревога», «обрыв», «замыкание»), тип каждого из организуемых шлейфов – нормально замкнутый, нормально разомкнутый, с одним или двумя оконечными резисторами – задается пользователем при конфигурировании изделия;
