...
* Для совместной работы с изделием в варианте исполнения «Норд GSM WRL» (с установленным радиорасширителем «СН-РАДИО») могут использоваться следующие оконечные устройства:
