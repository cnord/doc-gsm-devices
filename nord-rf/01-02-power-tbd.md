...
* внешний источник бесперебойного электроснабжения (UPS), номинальным выходным напряжением 12 В и допустимой токовой нагрузкой не менее 3,0 А с установленной в нем АКБ требуемой химической системы, при этом внешний UPS подключается к изделию вместо АКБ.
...
Рекомендуемая емкость АКБ, размещаемой в корпусе изделия – 7,2 А·ч.
