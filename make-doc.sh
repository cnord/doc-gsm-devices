...
# pandoc --latex-engine=/Library/TeX/texbin/pdflatex --template tex/nord-template.latex -V lang=russian -o nord-gsm-manual.pdf nord/04-01-install-general.md common/04-02-install-zones.md nord/04-03-install-zones-v51.md common/04-04-install-smoke.md common/04-05-install-wze-8.md nord/04-06-install-gsm.md
