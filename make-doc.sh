...
# pandoc --latex-engine=/Library/TeX/texbin/pdflatex --template tex/nord-rf-template.latex -V lang=russian -o nord-rf-manual.pdf nord-rf/01-01-purpose.md
...
# pandoc --latex-engine=/Library/TeX/texbin/pdflatex --template tex/sergeant-template.latex -V lang=russian -o sergeant-gsm-manual.pdf sergeant/01-01-purpose.md
